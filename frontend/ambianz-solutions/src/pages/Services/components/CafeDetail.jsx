    ...
    <div className="bg-[#F8F6F1] min-h-screen">
      ...
      <section className="relative h-[85vh] overflow-hidden">
        ...
        <div className="absolute inset-0 bg-black/50 flex flex-col items-center justify-center text-center px-4">
          ...
          <p className="font-raleway text-white/80 text-[14px] max-w-lg mb-10 leading-relaxed italic">
            "Engineering sensory environments where artisanal coffee culture
      ...
      <section className="max-w-[1200px] mx-auto py-32 px-8 flex flex-col md:flex-row gap-20 items-center">
        <div className="flex-1 space-y-10">
          ...
          <p className="font-raleway text-gray-500 text-[15px] leading-relaxed">
            Beyond aesthetics, we manipulate the intangible. Our fit-outs master
            the atmospheric performances of light, acoustics, and tactile
            materiality that define the guest's lingering memory.
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-10 pt-4">
            <div className="space-y-3">
              <h4 className="font-cinzel text-[13px] font-bold text-[#1A1C19] uppercase tracking-wider">
                Lighting Control
              </h4>
              <p className="font-raleway text-[12px] text-gray-400 leading-relaxed">
                Dynamic light management that transitions with the sun,
                enhancing the beans' natural hue.
              </p>
            </div>
            <div className="space-y-3">
              <h4 className="font-cinzel text-[13px] font-bold text-[#1A1C19] uppercase tracking-wider">
              ...
              <p className="font-raleway text-[12px] text-gray-400 leading-relaxed">
                Intelligent sound dampening for intimate coffee rituals and
                focused roasting sessions.
              </p>
            </div>
          </div>
        </div>
        <div className="flex-1 relative">
          <div className="h-[550px] w-full overflow-hidden shadow-2xl relative">
            ...
            <div className="absolute bottom-6 right-6 bg-white p-6 shadow-xl max-w-[200px] hidden md:block">
              <p className="font-raleway text-[10px] text-gray-400 italic">
                "The space should feel like the first sip — concentrated and
                pure."
              </p>
            </div>
          </div>
            ...
            {[
              ...
              <div key={i} className="space-y-6 group cursor-pointer">
                ...
                <div className="space-y-2">
                  <p className="font-raleway text-[#adb940] text-[9px] tracking-[2px] uppercase">
                    {project.location}
                  </p>
                  <h4 className="font-cinzel text-[18px] font-bold text-[#1A1C19] group-hover:text-[#3c5a25] transition-colors">
                    {project.title}
                  </h4>
                  <p className="font-raleway text-gray-400 text-[10px] tracking-[3px] uppercase">
                    {project.tag}
                  </p>
                </div>
              </div>
          ...
          <div className="flex-1 space-y-12">
            ...
            <div className="space-y-10">
              {[
                {
                  num: "01",
                  title: "Artisan Countertops",
                  desc: "Seamless, heat-resistant surfaces engineered for heavy commercial espresso services.",
                },
                {
                  num: "02",
                  title: "Bespoke Millwork",
                  desc: "Hand-crafted cabinetry tailored for the ergonomics of specialty brewing.",
                },
                {
                  num: "03",
                  title: "Spatial Rhythm",
                  desc: "Flow-driven architecture that balances staff work-flow with guest sanctuary.",
                },
              ].map((feature, i) => (
                <div
                  key={i}
                  className="flex gap-6 group border-b border-white/10 pb-8"
                >
                  <span className="font-cinzel text-[#adb940] text-xl opacity-60">
                    {feature.num}
                  </span>
                  <div className="space-y-2">
                    <h4 className="font-cinzel text-[15px] font-bold uppercase tracking-widest">
                      {feature.title}
                    </h4>
                    <p className="font-raleway text-white/40 text-[12px] leading-relaxed max-w-sm">
                      {feature.desc}
                    </p>
                  </div>
                </div>
      ...
      <section className="py-24 max-w-[1200px] mx-auto px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {[
            {
              title: "Discovery",
              desc: "Understanding your coffee brand identity and target guest demographic.",
            },
            {
              title: "Blueprint",
              desc: "Conceptualizing the workflow and aesthetic choreography of the space.",
            },
            {
              title: "Craft",
              desc: "On-site execution using artisanal materials and precision industrial engineering.",
            },
            {
              title: "Handover",
              desc: "The final tuning of acoustics and lighting for opening-day perfection.",
            },
          ].map((step, i) => (
            <div
              key={i}
              className="bg-gray-50 p-10 space-y-4 border border-transparent hover:border-[#adb940] transition-colors"
            >
              <span className="font-cinzel text-[32px] font-bold text-[#adb940]/20 block">
                0{i + 1}
              </span>
              <h4 className="font-cinzel text-[16px] font-bold text-[#1A1C19] uppercase tracking-wider">
                {step.title}
              </h4>
              <p className="font-raleway text-gray-400 text-[11px] leading-relaxed">
                {step.desc}
              </p>
            </div>
          ))}
      ...
      <section className="bg-[#1A1C19] py-32 text-center space-y-12 px-4 shadow-2xl relative overflow-hidden">
        ...
        <div className="relative space-y-10">
          <p className="font-raleway text-[#adb940] text-[10px] tracking-[6px] uppercase">
            ADJACENT
          </p>
