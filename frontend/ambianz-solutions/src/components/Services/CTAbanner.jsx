...
const CTAbanner = () => {
    return (
        <div className='relative py-16 px-10 overflow-hidden bg-gray-50'>
            ...
            <div className='relative z-10 flex flex-col items-center text-center gap-5'>
                ...
                {/* Heading */}
                <h2 className='font-cinzel text-[38px] font-bold leading-tight max-w-[600px]
                               text-gray-900'>
                    Ready to Transform Your Space?
                </h2>

                {/* Subtext */}
                <p className='font-raleway text-[14px] text-gray-400 max-w-[480px] leading-relaxed'>
                    Let's bring your vision to life. Book a free consultation with our
                    expert designers and get a 3D preview of your dream space — completely free.
                </p>
                ...
                <div className='flex gap-4 mt-3'>
                    <button className='font-cinzel px-10 py-3.5 bg-green-800 text-white
                                       text-[12px] tracking-widest uppercase border-2 border-green-800
                                       hover:bg-transparent hover:text-[#d1c400] hover:border-[#d1c400]
                                       transition-all duration-300 cursor-pointer relative group overflow-hidden'>
                        <span className='absolute inset-0 translate-x-[-100%] group-hover:translate-x-[100%]
                                         bg-gradient-to-r from-transparent via-white/10 to-transparent
                    ...
                    <button className='font-cinzel px-10 py-3.5 bg-transparent text-gray-400
                                       text-[12px] tracking-widest uppercase border-2 border-transparent
                                       hover:text-[#d1c400] hover:border-[#d1c400]
                                       transition-all duration-300 cursor-pointer'>
                        View Our Work →
                    </button>
                ...
                {/* Trust line */}
                <p className='font-raleway text-[11px] text-gray-400 tracking-[3px] mt-1'>
                    FREE CONSULTATION · NO COMMITMENT · 3D PREVIEW INCLUDED
                </p>
