        ...
        <>
            ...
            <div className='navbar w-[full]  '>
                ...
                <div className="bottom-navbar w-full h-[50px] bg-[#f0ece4] p-[10px] flex items-center justify-center gap-[20px]  ">
                    ...
                    <button className='rounded-[15px] outline-none border-none bg-[#e4d722] text-gray-800 p-[4px] text-[14px] w-[100px] font-raleway' >Hardware</button>
                    <button className='rounded-[15px] outline-none border-none bg-[#e4d722] text-gray-800 p-[4px] text-[14px] w-[100px] font-raleway' >Mirrors</button>
