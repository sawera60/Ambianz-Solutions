  ...
  return (
    <div className='min-h-screen bg-white'>
      ...
      <div className='px-10 py-10 border-b border-gray-100'>
        ...
        <h1 className='font-cinzel text-[38px] font-bold mt-2
                               bg-gradient-to-r from-[#3c5a25] via-[#d1c400] to-[#3c5a25]
                               bg-clip-text text-transparent'>
          Our Collection
        </h1>
        <p className='font-raleway text-[14px] text-gray-400 mt-2'>
          Showing <span className='text-green-900 font-semibold'>12 products</span> — Curated for premium living
        </p>
      </div>
        ...
        <div className='flex-1 flex flex-col gap-6'>
          ...
          <div className='flex items-center justify-between border-b border-gray-100 pb-4'>
            ...
            <div className='flex items-center gap-2'>
              <span className='font-raleway text-[12px] text-gray-300 tracking-widest uppercase mr-2'>
                View
              </span>
                ...
                <div key={product.id}
                    ...
                    <div className='absolute inset-0 bg-black/0 group-hover:bg-black/20
                      ...
                      <div className='opacity-0 group-hover:opacity-100 transition-all duration-300 flex gap-2'>
                        <button className='w-9 h-9 bg-white flex items-center justify-center
                                                                   hover:bg-[#d1c400] transition-all duration-300 text-[14px]'>
                          🤍
                        </button>
                        <button className='w-9 h-9 bg-white flex items-center justify-center
                                                                   hover:bg-[#d1c400] transition-all duration-300 text-[14px]'>
                  ...
                  <div className='p-4 flex flex-col gap-2'>
                    ...
                    <div className='flex items-center justify-between mt-1'>
                      <span className='font-cinzel text-[15px] font-bold text-green-900'>
                        {product.price}
                      </span>
                ...
                <div key={product.id}
                  ...
                  <div className='flex items-center justify-between w-full px-6 py-4'>
                    ...
                    <div className='flex items-center gap-6'>
                      <span className='font-cinzel text-[16px] font-bold text-green-900'>
                        {product.price}
                      </span>
          ...
          <div className='flex items-center justify-center gap-2 mt-4'>
            <button className='font-cinzel w-9 h-9 border-2 border-gray-200 text-gray-300
                                           hover:border-[#d1c400] hover:text-[#d1c400]
                                           transition-all duration-300 cursor-pointer text-[16px]'>
              ‹
            </button>
            {[1, 2, 3, 4, 5].map((num) => (
              <button key={num}
                className={`font-cinzel w-9 h-9 border-2 text-[13px]
                                            transition-all duration-300 cursor-pointer
                                            ${num === 1
                    ? 'border-green-800 bg-green-800 text-white'
      ...
      {/* Bottom Banner */}
      <div className='mx-10 mb-10 mt-4 bg-green-900 px-10 py-10
        ...
        <div className='absolute top-0 right-0 w-[300px] h-[300px] rounded-full
                                bg-yellow-600/10 blur-[80px] pointer-events-none' />
        <div className='flex flex-col gap-2'>
          <span className='font-raleway text-[11px] text-[#d1c400] tracking-[4px] uppercase'>
            Can't find what you're looking for?
          </span>
          <h3 className='font-cinzel text-[24px] font-bold text-white'>
            Get a Bespoke Design Made Just For You
          </h3>
          <p className='font-raleway text-[13px] text-white/50 max-w-[500px]'>
            Our designers can create custom furniture, lighting and decor
            tailored exactly to your space and style.
          </p>
        </div>
        <button className='font-cinzel px-8 py-3 bg-transparent text-white
                                   border-2 border-[#d1c400] text-[13px] tracking-widest uppercase
                                   hover:bg-[#d1c400] hover:text-black
